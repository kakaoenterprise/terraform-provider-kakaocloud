...
# List instance flavors with filters
data "kakaocloud_instance_flavors" "filtered" {
  filter = [
    ...
    {
      name  = "instance_type"
      value = "vm" # Possible values: vm, bm, gpu
    },
    {
      name  = "instance_family"
      value = "c2a" # Example values: r2a, c2a
    },
    {
      name  = "is_burstable"
...
output "all_flavors" {
  ...
  value = {
    count = length(data.kakaocloud_instance_flavors.all.instance_flavors)
    ids   = data.kakaocloud_instance_flavors.all.instance_flavors[*].id
    names = data.kakaocloud_instance_flavors.all.instance_flavors[*].name
  }
}
...
output "filtered_flavors" {
  ...
  value = {
    count = length(data.kakaocloud_instance_flavors.filtered.instance_flavors)
    ids   = data.kakaocloud_instance_flavors.filtered.instance_flavors[*].id
    names = data.kakaocloud_instance_flavors.filtered.instance_flavors[*].name
  }
}
```
