...
description: |-
  ...
  | type                      | string                     | Type of the load balancer <br> - `ALB`, `NLB`, `NLB_L4_DSR` |
...
It supports filtering by attributes such as name or project, and provides details including availability zone, VPC
configuration, provisioning and operating status, listener information, and VIP addresses.
