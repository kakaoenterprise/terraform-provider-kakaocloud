...
It provides details such as size, type, availability zone, attachment status, encryption settings, and associated
instance information.

Use this data source when you need to reference an existing Volume in your Terraform configuration without hardcoding
